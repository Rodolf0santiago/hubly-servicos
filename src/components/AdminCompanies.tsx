                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex gap-2">
                      <input 
                        ...
                        readOnly
                        disabled
                        className="w-full text-xs px-3 py-2 border border-slate-200 rounded-md bg-slate-50 text-slate-500 cursor-not-allowed focus:outline-none"
                      />
                      <div className="flex items-center text-yellow-400 opacity-50">
