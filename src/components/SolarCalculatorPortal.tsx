...
export default function SolarCalculatorPortal() {
  ...
  const handleWhatsApp = async () => {
    ...
    const msg = `Olá! Fiz uma simulação na Integra Soluções SC e meu potencial de economia solar é de *${fmt(result.economiaA)}/ano* com um sistema de *${result.potencia} kWp*. Quero saber mais!`;
    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-8 md:py-12 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
      ...
      <div className="flex-1 text-center lg:text-left space-y-8">
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }}
          ...
          <Zap className="w-4 h-4 fill-brand-emerald" /> Integra Soluções SC Solar
        </motion.div>
