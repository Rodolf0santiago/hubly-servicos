    ...
    <main className="flex-1 flex flex-col items-center w-full overflow-x-hidden relative bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <header className="absolute top-0 w-full px-6 py-6 md:px-12 md:py-8 flex justify-between items-center z-50">
        <Link href="/" className="flex items-center group cursor-pointer">
          <img src="/images/logo.png" alt="Integra Soluções SC" className="h-[4.5rem] sm:h-20 md:h-24 lg:h-28 w-auto object-contain drop-shadow-md transition-transform duration-500 group-hover:scale-105 dark:bg-white/95 dark:px-3 dark:py-1.5 dark:rounded-xl dark:shadow-sm" />
        </Link>
        ...
        <div className="max-w-[1440px] mx-auto text-center">
          ...
          >
            <motion.div variants={fadeUp} className="w-full lg:w-1/2 rounded-2xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700 relative group">
              ...
              <img src="/images/crm-dashboard-2.png?v=2" alt="Dashboard do CRM mostrando empresas homologadas e qualidade da rede" className="w-full h-auto object-cover transform group-hover:scale-105 transition-transform duration-700" />
            </motion.div>
            <motion.div variants={fadeUp} className="w-full lg:w-1/2 rounded-2xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700 relative group">
              <div className="absolute inset-0 bg-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity z-10" />
              <img src="/images/crm-dashboard-1.jpg?v=2" alt="Lista de empresas no CRM com pontuação e status" className="w-full h-auto object-cover transform group-hover:scale-105 transition-transform duration-700" />
            </motion.div>
          </motion.div>
        </div>
      </section>
