    ...
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center relative overflow-hidden">
      ...
      <header className="absolute top-0 w-full px-4 py-4 md:px-8 md:py-6 flex justify-between items-center z-50">
        <Link href="/" className="flex items-center group cursor-pointer">
          <img src="/images/logo.png" alt="Integra Soluções SC" className="h-[4.5rem] sm:h-20 md:h-24 lg:h-28 w-auto object-contain drop-shadow-md transition-transform duration-300 group-hover:scale-105 dark:invert dark:hue-rotate-180" />
        </Link>
        <ThemeToggle />
      </header>

      {/* Hero Service */}
      <section className="w-full pt-48 md:pt-56 lg:pt-[240px] pb-0 px-4 flex flex-col items-center">
      ...
      <GaleriaSection servico="automacao_residencial" />
